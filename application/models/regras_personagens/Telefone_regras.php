...
/**
 * Description of Telefone_regras
 *
 * @author 033234581
 */
class Telefone_regras extends CI_Model{
    //put your code here
    public function confirmaTelefone($pizzaria, $idCliente, $personagem, $nome){
