...
<nav class="menu">
  <ul>
    <li><a href="">MENSAGENS</a>
        <ul>
            <li><a href="http://localhost/produto-api/index.php/controladorJson/comunicador_json_produto/mensagemWelcomeDoProduto?CodgEmpresa=1">
                    Welcome</a></li>
            <li><a href="http://localhost/produto-api/index.php/controladorJson/comunicador_json_produto/respostaPadraoProduto?CodgEmpresa=1&first_name=Alexandre&last_name=tomasi&last_user_freeform_input=nadadad&last_visited_block_name=Welcome_message&fluxo=1">
                    Resposta Padrao</a></li>
            <li><a href="http://localhost/produto-api/index.php/controladorJson/comunicador_json_produto/verificarHorarioAtendimentoNormalEspecial?CodgEmpresa=1">
                    Verifica Horario Atendimento</a></li>
