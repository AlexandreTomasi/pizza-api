                            ...
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                            <label for="razao_social_pizzaria">Razão Social: </label>
                                            <input type="text" readonly="true" disabled="true" id="razao_social_pizzaria" name="razao_social_pizzaria" ng-model="pizzaria.razao_social_pizzaria"  required aria-required="true" ng-pattern="/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+([0-9,.'-()]+)?/" placeholder="">
                                    </div><!-- End of FirstName -->

                                    <!-- MiddleName -->
                                    <div class="input-field col s12">
                                            <label for="nome_fantasia_pizzaria">Nome fantasia: <span class="asterisk">*</span></label>
                                            <input type="text" id="nome_fantasia_pizzaria" name="nome_fantasia_pizzaria" ng-model="pizzaria.nome_fantasia_pizzaria" aria-required="true" required placeholder=""></input>
                                            <div ng-if="configForm.nome_fantasia_pizzaria.$error.required && configForm.nome_fantasia_pizzaria.$dirty" style="color:red">Campo obrigatório.</div>
                                    </div><!-- End of MiddleName -->

                                    <!-- LastName REQUIRED -->
                                    <div class="input-field col s6">
                                            <label for="cnpj_pizzaria">CNPJ </label>
                                            <input type="text" readonly="true" disabled="true" cnpj-input id="cnpj_pizzaria" name="cnpj_pizzaria" ng-model="pizzaria.cnpj_pizzaria" aria-required="true" required placeholder=""></input>
                                    </div><!-- End of LastName -->

                                    <!-- LastName REQUIRED -->
                                    <div class="input-field col s6">
                                            <label for="perfil_facebook_pizzaria">Perfil Facebook: </label>
                                            <input type="text" readonly="true" disabled="true" id="perfil_facebook_pizzaria" name="perfil_facebook_pizzaria" ng-model="pizzaria.perfil_facebook_pizzaria" aria-required="true" required placeholder=""></input>
                                    </div><!-- End of LastName -->
                                    <!-- LastName REQUIRED -->
                                    <div class="input-field col s6">
                                            <label for="telefone_pizzaria">Telefone: <span class="asterisk">*</span></label>
                                            <input type="text" id="telefone_pizzaria" phone-input name="telefone_pizzaria" ng-model="pizzaria.telefone_pizzaria" aria-required="true" required placeholder=""></input>
                                            <div ng-if="configForm.telefone_pizzaria.$error.required && configForm.telefone_pizzaria.$dirty" style="color:red">Campo obrigatório.</div>
                                    </div><!-- End of LastName -->
                                    <!-- LastName REQUIRED -->

                                    <!-- Zip REQUIRED -->
                                    <div class="input-field col s6">
                                            <label for="cep_pizzaria">CEP: <span class="asterisk">*</span></label> <span id="errmsgZip"></span>
                                            <input type="text" id="cep_pizzaria" name="cep_pizzaria" ng-model="pizzaria.cep_pizzaria"  cep-input class="no-spaces numeric required" required placeholder=""></input>
                                    </div><!-- End of Zip -->
                                    <!-- LastName REQUIRED -->
                                    <div class="input-field col s12">
                                            <label for="endereco_pizzaria">Endereço (Rua, Avenida): <span class="asterisk">*</span></label>
                                            <textarea class="materialize-textarea" type="text" id="LastName" name="endereco_pizzaria" ng-model="pizzaria.endereco_pizzaria" aria-required="true" required placeholder=""></textarea>
                                    </div><!-- End of LastName -->
                                    <!-- LastName REQUIRED -->
                                    <div class="input-field col s6">
                                            <label for="numero_endereco_pizzaria">Número: <span class="asterisk">*</span></label>
                                            <input type="text" id="numero_endereco_pizzaria" name="numero_endereco_pizzaria" ng-model="pizzaria.numero_endereco_pizzaria" aria-required="true" required placeholder=""></input>
                                            <div ng-if="configForm.numero_endereco_pizzaria.$error.required && configForm.numero_endereco_pizzaria.$dirty" style="color:red">Campo obrigatório.</div>
                                    </div><!-- End of LastName -->
                                    <!-- LastName REQUIRED -->
                                    <div class="input-field col s6">
                                            <label for="complemento_endereco_pizzaria">Complemento: </label>
                                            <input type="text" id="complemento_endereco_pizzaria" name="complemento_endereco_pizzaria" ng-model="pizzaria.complemento_endereco_pizzaria" aria-required="true"  placeholder=""></input>
                                    </div><!-- End of LastName -->
                                    <!-- LastName REQUIRED -->
                                    ...
                                    <!-- Email REQUIRED -->
                                    <div class="input-field col s12">
                                            <label for="email_pizzaria">E-mail:  <span id="errmsgEmail"></span></label>
                                            <input type="text" readonly="true" disabled="true" id="email_pizzaria" name="email_pizzaria" ng-model="pizzaria.email_pizzaria"  placeholder="">
                                            <div ng-if="configForm.email_pizzaria.$error.required && configForm.email_pizzaria.$dirty" style="color:red">Campo obrigatório.</div>
                                    </div><!-- End of Email -->
        
                                    <!-- City REQUIRED -->
                                    <div class="input-field col s12">
                                            <label for="senha_cliente">Senha atual: </label>
                                            <input type="password" id="senha_cliente" name="senha_cliente" ng-model="pizzaria.senha_cliente"  placeholder="">
                                    </div><!-- End of City -->
                                    <!-- City REQUIRED -->
                                    <div class="input-field col s12">
...
<script>
    ...
    app.controller('configPizzaria', function ($scope, $http) {
            ...
            $scope.sendPost = function() {  
                    $scope.pizzaria.bairro_pizzaria = $scope.SelectBairro;
                    $scope.pizzaria.uf_pizzaria = $scope.State;
                    $scope.pizzaria.cidade_pizzaria = $scope.selectCit;
