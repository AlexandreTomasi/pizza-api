            ...
            */
            ...
            (min-device-width: 768px) and (max-device-width: 1024px)  {
                ...
                */
                ...
                td:nth-of-type(2):before { content: "Quantidade de sabores:"; font-weight: bold;}
                td:nth-of-type(3):before { content: "Quantidade de fatias:"; font-weight: bold;}
                ...
                <div class="row">
                    <div class="col s12">
                        ...
                        <div class="input-field col s8 nopad">
                            <input type="text" ng-model="search" class="form-control" placeholder="Pesquisar tamanho..." />
                        </div>
                    </div>
                    <br>
                    <div class="sorter"><h6 style="display: inline-block;">Ordenar por: </h6>
                        <a  ng-class="{'activetab  waves-light' : predicate === 'descricao_tamanho_pizza',  'disabled': predicate !== 'descricao_tamanho_pizza'}"
                            ng-click="predicate = 'descricao_tamanho_pizza'; reverse = !reverse" class="btn">Descricao
                            <i ng-show="predicate === 'descricao_tamanho_pizza' && !reverse" class="material-icons right">expand_more</i>
                            <i ng-show="predicate === 'descricao_tamanho_pizza' && reverse" class="material-icons right">expand_less</i>
                        </a>
                        <a  ng-class="{'activetab  waves-light' : predicate == 'ativo_tamanho_pizza',  'disabled': predicate != 'ativo_tamanho_pizza'}"
                            ng-click="predicate = 'ativo_tamanho_pizza'; reverse = !reverse" class="btn">Status
                            <i ng-show="predicate == 'ativo_tamanho_pizza' && !reverse" class="material-icons right">expand_more</i>
                            <i ng-show="predicate == 'ativo_tamanho_pizza' && reverse" class="material-icons right">expand_less</i>
                        </a>
                    </div>
                    ...
                    <table class="table hoverable bordered">
                        <thead>
                            <tr>
                                <th ng-class="{'activetab waves-effect waves-light' : predicate === 'descricao_tamanho_pizza'}"  ng-click="predicate = 'descricao_tamanho_pizza';
                                            reverse = !reverse">Descrição
                                    <i ng-show="predicate === 'descricao_tamanho_pizza' && !reverse" class="material-icons right">expand_more</i>
                                    <i ng-show="predicate === 'descricao_tamanho_pizza' && reverse" class="material-icons right">expand_less</i>
                                </th>        
                                <th class="text-align-center">Quantidade de sabores</th>
                                <th class="text-align-center">Quantidade de fatias</th>
                                <th class="text-align-center" ng-class="{'activetab waves-effect waves-light' : predicate == 'ativo_tamanho_pizza'}"  ng-click="predicate = 'ativo_tamanho_pizza';
                        ...
                        <tbody>
                            <tr dir-paginate="produto in produtos | filter:search:buscaSemAcento | filter:filters | orderBy:predicate:reverse | itemsPerPage: resultlimit ">                              
                                <td class="dados">{{produto.descricao_tamanho_pizza}} </td>  
                                <td class="text-align-center"> {{produto.quantidade_sabor_tamanho_pizza}} </td> 
                                <td class="text-align-center"> {{produto.quantidade_fatias_tamanho_pizza}} </td>
                                <td class="text-align-center"> {{produto.ativo_tamanho_pizza}} </td>
                                <td class="text-align-center" >
                                    <a ng-click="ativarProduto(produto.codigo_tamanho_pizza)" title="ativar tamanho" class="waves-light btn customAction" ng-if="produto.ativo_tamanho_pizza == 'Inativo'"><i class="material-icons centered">check</i></a>
                                    <a ng-click="inativarProduto(produto.codigo_tamanho_pizza)" title="inativar tamanho" class="waves-light btn customAction" ng-if="produto.ativo_tamanho_pizza == 'Ativo'"><i class="material-icons centered">close</i></a>
                                    <a ng-click="carregarProduto(produto.codigo_tamanho_pizza)" title="alterar tamanho" class="waves-light btn customAction" ><i class="material-icons centered">edit</i></a>
                                    <a ng-click="excluirProduto(produto.codigo_tamanho_pizza)" title="excluir tamanho" class="waves-light btn customAction"><i class="material-icons centered">delete</i></a>
                                </td>    
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <form name="produtoForm" id="modal-produto-form" class="modal" novalidate>
                        <div class="modal-content">
                            <h4 id="modal-produto-title">Inserir tamanho</h4>
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" ng-model="descricaoInput" name="descricaoInput" id="descricaoInput" required aria-required="true" ng-pattern="/^[[0-9A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+([,.'-()]+)?/" placeholder="Descrição do tamanho"/>
                                ...
                                <div class="input-field col s12">
                                    <input type="number" ng-model="precoInput" name="precoInput" id="precoInput" required ng-pattern="/^[0-9]/"  placeholder="Quantidade máxima de sabores" step="1" min="0"/>
                                    <label for="precoInput">Quantidade de sabores</label>
                                </div>
                                <div class="input-field col s12">
                                    <input type="number" ng-model="fatiasInput" name="fatiasInput" id="fatiasInput" required ng-pattern="/^[0-9]/"  placeholder="Quantidade de fatias" step="1" min="1"/>
                                    <label for="fatiasInput">Quantidade de fatias</label>
                                </div>
                                <div ng-if="produtoForm.precoInput.$error.required && produtoForm.precoInput.$dirty" style="color:red">Campo obrigatório.</div> 
                                <div ng-if="produtoForm.precoInput.$error.pattern && produtoForm.precoInput.$dirty" style="color:red">Formato: #,## - Campo inválido.</div> 
                                <div ng-if="produtoForm.precoInput.$error.min && produtoForm.precoInput.$dirty" style="color:red">Valor deve ser maior que 0.</div> 
                                
                                <div ng-if="produtoForm.fatiasInput.$error.required && produtoForm.fatiasInput.$dirty" style="color:red">Campo obrigatório.</div> 
                                <div ng-if="produtoForm.fatiasInput.$error.pattern && produtoForm.fatiasInput.$dirty" style="color:red">Formato: #,## - Campo inválido.</div> 
                                <div ng-if="produtoForm.fatiasInput.$error.min && produtoForm.fatiasInput.$dirty" style="color:red">Valor deve ser maior que 0.</div> 
                    ...
                    <div class="fixed-action-btn" style="bottom:45px; right:24px;">
                        <a class="waves-effect waves-light btn modal-trigger btn-floating btn-large red" href="#modal-produto-form" title="inserir tamanho" ng-click="showCreateForm()"><i class="large material-icons">add</i></a
                    </div> <!-- END BUTTON -->
...
<script>
    ...
    app.controller('ControladorProduto', function ($scope, $http) {
        // read produtos
        $scope.produtos = <?php echo json_encode($tamanhos) ?>;
       ...
       $scope.page = [{valor: "1",desc: "1"}, 
        ...
        $scope.showCreateForm = function () {
            ...
            $scope.clearForm();
            // change modal title
            $('#modal-produto-title').text("Inserir Tamanho");
        ...
        $scope.incluirProduto = function () {
            ...
            $http.post('<?=base_url("index.php/ControladorPizzas/incluirTamanho")?>', {
                'descricao_tamanho_pizza': $scope.descricaoInput,
                'quantidade_sabor_tamanho_pizza' : $scope.precoInput,
                'quantidade_fatias_tamanho_pizza' : $scope.fatiasInput
            }
        ...
        $scope.carregarProduto = function (id) {
            // change modal title
            $('#modal-produto-title').text("Alterar Tamanho");
            // show udpate produto button
            $('#btn-update-produto').show();
            // show create produto button
            $('#btn-create-produto').hide();
            // post id of produto to be edited
            $http.post('<?=base_url("index.php/ControladorPizzas/buscarTamanhoPorCodigo")?>', {
                'codigo_tamanho_pizza': id
            }).success(function (data, status, headers, config) {
                        // put the values in form
                        $scope.codigo_tamanho_pizza = data["codigo_tamanho_pizza"];
                        $scope.descricaoInput = data["descricao_tamanho_pizza"];
                        $scope.precoInput = parseInt(data["quantidade_sabor_tamanho_pizza"]);
                        $scope.fatiasInput = parseInt(data["quantidade_fatias_tamanho_pizza"]);
                        // show modal
        ...
        $scope.alterarProduto = function () {
            $http.post('<?=base_url("index.php/ControladorPizzas/alterarTamanho")?>', {
                'codigo_tamanho_pizza': $scope.codigo_tamanho_pizza,
                'descricao_tamanho_pizza': $scope.descricaoInput,
                'quantidade_sabor_tamanho_pizza' : $scope.precoInput,
                'quantidade_fatias_tamanho_pizza' : $scope.fatiasInput
            }).success(function (data, status, headers, config) {      
                        ...
                        for (numero=0; numero < $scope.produtos.length; numero++){
                            if(parseInt($scope.produtos[numero].codigo_tamanho_pizza) === parseInt($scope.codigo_tamanho_pizza)) {
                                $scope.produtos[numero].descricao_tamanho_pizza = $scope.descricaoInput;
                                $scope.produtos[numero].quantidade_sabor_tamanho_pizza = $scope.precoInput;
                                $scope.produtos[numero].quantidade_fatias_tamanho_pizza = $scope.fatiasInput;
                            }
                        }
                        // close modal
                        $('#modal-produto-form').closeModal();
        ...
        $scope.excluirProduto = function (codigo) {
            if (confirm("Tem certeza que deseja excluir?")) {                                                                                                                 
                $http.post('<?=base_url("index.php/ControladorPizzas/removerTamanho")?>', {
                    'codigo_tamanho_pizza': codigo
                }).success(function (data, status, headers, config) {
                    Materialize.toast("Dados excluídos com sucesso", 4000);                                           
                    for (numero=0; numero < $scope.produtos.length; numero++){
                        if($scope.produtos[numero].codigo_tamanho_pizza === codigo) {
        ...
        $scope.ativarProduto = function (codigo) {
            if (confirm("Deseja reativar esse produto? Ao ativar o produto, o bot voltará a apresentar esse produto para compra.")) {
                $http.post('<?= base_url("index.php/ControladorPizzas/ativarTamanho") ?>', {
                    'codigo_tamanho_pizza': codigo
                }).success(function (data, status, headers, config) {
                    // tell the user bebida record was updated
                    Materialize.toast("Dados alterados com sucesso", 4000);
                    for (numero = 0; numero < $scope.produtos.length; numero++) {
                        if (parseInt($scope.produtos[numero].codigo_tamanho_pizza) === parseInt(codigo)) {
                            $scope.produtos[numero].ativo_tamanho_pizza = "Ativo";
                        }
        ...
        $scope.inativarProduto = function (codigo) {
            if (confirm("Deseja inativar esse produto? Ao inativar o produto, o bot não apresentará esse produto para compra até que este esteja ativo novamente.")) {
                $http.post('<?= base_url("index.php/ControladorPizzas/inativarTamanho") ?>', {
                    'codigo_tamanho_pizza': codigo
                }).success(function (data, status, headers, config) {
                    // tell the user bebida record was updated
                    Materialize.toast("Dados alterados com sucesso", 4000);
                    for (numero = 0; numero < $scope.produtos.length; numero++) {
                        if (parseInt($scope.produtos[numero].codigo_tamanho_pizza) === parseInt(codigo)) {
                            $scope.produtos[numero].ativo_tamanho_pizza = "Inativo";
                        }
