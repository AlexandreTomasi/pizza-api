        ...
        <style>
            ...
            */
            ...
            (min-device-width: 768px) and (max-device-width: 1024px)  {
                ...
                Label the data
                */
                td.dados:nth-of-type(1):before { content: "Sabor:"; font-weight: bold;}
                td.dados:nth-of-type(2):before { content: "Tamanho:"; font-weight: bold;}
                td.dados:nth-of-type(3):before { content: "Valor:"; font-weight: bold;}
            }
                ...
                <div class="row">
                    <div class="col s12">
                        ...
                        <div class="input-field col s8 nopad">
                            <input type="text" ng-model="search" class="form-control" placeholder="Pesquisar pizza..." />
                        </div>
                    </div>
                    <br>
                    <div class="sorter"><h6 style="display: inline-block;">Ordenar por: </h6>
                        <a  ng-class="{'activetab  waves-light' : predicate === 'sabor_pizza_valor_pizza',  'disabled': predicate !== 'sabor_pizza_valor_pizza'}"
                            ng-click="predicate = 'sabor_pizza_valor_pizza'; reverse = !reverse" class="btn">Sabor
                            <i ng-show="predicate === 'sabor_pizza_valor_pizza' && !reverse" class="material-icons right">expand_more</i>
                            <i ng-show="predicate === 'sabor_pizza_valor_pizza' && reverse" class="material-icons right">expand_less</i>
                        </a>
                        <a ng-class="{'activetab  waves-light' : predicate === 'tamanho_pizza_valor_pizza',  'disabled': predicate !== 'tamanho_pizza_valor_pizza'}"
                           ng-click="predicate = 'tamanho_pizza_valor_pizza'; reverse = !reverse" class="btn">Tamanho
                            <i ng-show="predicate === 'tamanho_pizza_valor_pizza' && !reverse" class="material-icons right">expand_more</i>
                            <i ng-show="predicate === 'tamanho_pizza_valor_pizza' && reverse" class="material-icons right">expand_less</i>
                        </a>
                        <a ng-class="{'activetab  waves-light' : predicate === 'preco_valor_pizza',  'disabled': predicate !== 'preco_valor_pizza'}"
                           ng-click="predicate = 'preco_valor_pizza'; reverse = !reverse" class="btn">Valor
                            <i ng-show="predicate === 'preco_valor_pizza' && !reverse" class="material-icons right">expand_more</i>
                            <i ng-show="predicate === 'preco_valor_pizza' && reverse" class="material-icons right">expand_less</i>
                        </a>
                    </div>
                    ...
                    <table class="table hoverable bordered">
                        <thead>
                            <tr>
                                <th ng-class="{'activetab waves-effect waves-light' : predicate === 'sabor_pizza_valor_pizza'}"  ng-click="predicate = 'sabor_pizza_valor_pizza';
                                            reverse = !reverse">Sabor
                                    <i ng-show="predicate === 'sabor_pizza_valor_pizza' && !reverse" class="material-icons right">expand_more</i>
                                    <i ng-show="predicate === 'sabor_pizza_valor_pizza' && reverse" class="material-icons right">expand_less</i>
                                </th> 
                                <th ng-class="{'activetab waves-effect waves-light' : predicate === 'tamanho_pizza_valor_pizza'}" ng-click="predicate = 'tamanho_pizza_valor_pizza';
                                            reverse = !reverse">Tamanho
                                    <i ng-show="predicate === 'tamanho_pizza_valor_pizza' && !reverse" class="material-icons right">expand_more</i>
                                    <i ng-show="predicate === 'tamanho_pizza_valor_pizza' && reverse" class="material-icons right">expand_less</i>
                                </th>
                                <th ng-class="{'activetab waves-effect waves-light' : predicate === 'preco_valor_pizza'}" ng-click="predicate = 'preco_valor_pizza';
                                            reverse = !reverse">Valor
                                    <i ng-show="predicate === 'preco_valor_pizza' && !reverse" class="material-icons right">expand_more</i>
                                    <i ng-show="predicate === 'preco_valor_pizza' && reverse" class="material-icons right">expand_less</i>
                                </th>
                        ...
                        <tbody>
                            <tr dir-paginate="produto in produtos | filter:search:buscaSemAcento | filter:filters | orderBy:predicate:reverse | itemsPerPage: resultlimit ">                              
                                <td class="dados">{{produto.sabor_pizza_valor_pizza}} </td>      
                                <td class="dados">{{produto.tamanho_pizza_valor_pizza}} </td>
                                <td class="dados">{{ produto.preco_valor_pizza | currency:"R$ "}} </td>
                                <td class="text-align-center">
                                    <a ng-click="carregarProduto(produto.codigo_valor_pizza)" title="alterar pizza" class="waves-light btn customAction" ><i class="material-icons centered">edit</i></a>
                                    <a ng-click="excluirProduto(produto.codigo_valor_pizza)" title="excluir pizza" class="waves-light btn customAction"><i class="material-icons centered">delete</i></a>
                                </td>    
                            </tr>
                        </tbody>
                    ...
                    <form name="produtoForm" id="modal-produtoEdit-form" class="modal" novalidate>
                        <div class="modal-content">
                            <h4 id="modal-produtoEdit-title">Alterar Pizza</h4>
                            <div class="row">
                                <div class="input-field col s12">
                                    <input readonly="true" disabled="true" type="text" ng-model="saborInput" name="saborInput" id="saborInput" required aria-required="true" ng-pattern="/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+([0-9,.'-()]+)?/" placeholder="" />
                                    <label for="saborInput">Sabor</label>
                                </div>
                                <div class="input-field col s12">
                    ...
                    <form name="produtoCreateForm" id="modal-produto-form" class="modal" novalidate >
                        <div class="modal-content">
                            <h4 id="modal-produto-title">Inserir pizza</h4>
                            <div class="row">
                                <div class="input-field col s12">
                                    <select ng-model="selectedSabor" name="selectedSabor" id="selectedSabor" required ng-change="onChanged()"
                                            ng-options="prod.codigo_sabor_pizza as prod.descricao_sabor_pizza for prod in sabor" >
                                        <option value="">Selecione o Sabor</option>
                                    </select>
                                    <label for="selectedSabor">Sabor: </label>  
                                    <div ng-if="produtoCreateForm.selectedSabor.$error.required && produtoCreateForm.selectedSabor.$dirty" style="color:red">Campo obrigatório.</div>
                                    
                                    <!--<select class="" ng-model="selectedSabor" material-select watch> <option ng-repeat="value in sabor">{{value.descricao_sabor_pizza}}</option> </select>
-->
                            ...
                            <!--<label class="requiredFieldText">obs: Deixe campo vazio se não quiser inserir ou alterar.</label>--> 
                            <div class="input-field col nopad s12">
                    ...
                    <div class="fixed-action-btn" style="bottom:45px; right:24px;">
                        <a class="waves-effect waves-light btn modal-trigger btn-floating btn-large red" href="#modal-produto-form" title="inserir pizza" ng-click="showCreateForm()"><i class="large material-icons">add</i></a
                    </div> <!-- END BUTTON -->
...
<script>
                            ...
                            app.controller('ControladorProduto', function ($scope, $http) {
                                // read produtos
                                $scope.produtos = <?php echo json_encode($valores, JSON_NUMERIC_CHECK); ?>;
                                $scope.sabor =<?php echo json_encode($sabores); ?>;
                                $scope.tamanho =<?php echo json_encode($tamanhos, JSON_NUMERIC_CHECK); ?>;
                                ...
                                $scope.showCreateForm = function () {
                                    ...
                                    // change modal title
                                    $('#modal-produto-title').text("Inserir pizza");
                                ...
                                $scope.onChanged = function () {
                                    ...
                                    for (numero = 0; numero < $scope.sabor.length; numero++) {
                                        if (parseInt($scope.sabor[numero].codigo_sabor_pizza) == parseInt($scope.selectedSabor)) {
                                            $scope.descSabor = $scope.sabor[numero].descricao_sabor_pizza;
                                        }
                                    }
                                    for (numero = 0; numero < $scope.produtos.length; numero++) {
                                        if (0 == $scope.descSabor.localeCompare(($scope.produtos[numero].sabor_pizza_valor_pizza))) {
                                            for (i = 0; i < $scope.tamanho.length; i++) {
                                                if (0 == $scope.tamanho[i].descricao_tamanho_pizza.localeCompare($scope.produtos[numero].tamanho_pizza_valor_pizza)) {
                                                    $scope.values[i] = $scope.produtos[numero].preco_valor_pizza;
                                                }
                                            }
                                        }
                                    }
                                ...
                                $scope.incluirProduto = function () {
                                    ...
                                    $http.post('<?= base_url("index.php/ControladorPizzas/incluirValorPizzaria") ?>', {
                                        "sabor_pizza_valor_pizza": $scope.selectedSabor,
                                        ...
                                        for (i = 0; i < $scope.result.length; i++) {
                                            var permi = 0;
                                            for (numero = 0; numero < $scope.produtos.length; numero++) {
                                                if (parseInt($scope.produtos[numero].codigo_valor_pizza) === parseInt($scope.result[i].codigo_valor_pizza)) {
                                                    $scope.produtos[numero].preco_valor_pizza = $scope.result[i].preco_valor_pizza;
                                                    permi = 1;
                                                    break;
                                                }
                                            }
                                        ...
                                        Materialize.toast("Erro ao incluir dados. Verifique se a pizza já foi cadastrada", 34000);
                                ...
                                $scope.carregarProduto = function (id) {
                                    // change modal title
                                    $('#modal-produtoEdit-title').text("Alterar Pizza");
                                    ...
                                    $http.post('<?= base_url("index.php/ControladorPizzas/buscarValorPorCodigo") ?>', {
                                        'codigo_valor_pizza': id
                                    }).success(function (data, status, headers, config) {
                                        // mandar esses dados para o modal que depois manda para controler alterar
                                        $scope.codigo_valor_pizza = data["codigo_valor_pizza"];
                                        $scope.saborInput = data["sabor_pizza_valor_pizza"];
                                        $scope.tamanhoInput = data["tamanho_pizza_valor_pizza"];
                                        $scope.precoEntrada = parseFloat(data["preco_valor_pizza"]);
                                        // show modal
                                ...
                                $scope.alterarProduto = function () {
                                    $http.post('<?= base_url("index.php/ControladorPizzas/alterarValorPizzaria") ?>', {
                                        'codigo_valor_pizza': $scope.codigo_valor_pizza,
                                        'preco_valor_pizza': $scope.precoEntrada
                                    }).success(function (data, status, headers, config) {
                                        // tell the user produto record was updated    
                                        Materialize.toast("Dados alterados com sucesso", 4000);
                                        for (numero = 0; numero < $scope.produtos.length; numero++) {
                                            if (parseInt($scope.produtos[numero].codigo_valor_pizza) === parseInt($scope.codigo_valor_pizza)) {
                                                $scope.produtos[numero].preco_valor_pizza = $scope.precoEntrada;
                                            }
                                ...
                                $scope.excluirProduto = function (codigo) {
                                    if (confirm("Tem certeza que deseja excluir?")) {
                                        $http.post('<?= base_url("index.php/ControladorPizzas/confirmarRemoverValor") ?>', {
                                            'codigo_valor_pizza': codigo
                                        }).success(function (data, status, headers, config) {
                                            Materialize.toast("Dados excluídos com sucesso", 4000);
                                            for (numero = 0; numero < $scope.produtos.length; numero++) {
                                                if ($scope.produtos[numero].codigo_valor_pizza === codigo) {
